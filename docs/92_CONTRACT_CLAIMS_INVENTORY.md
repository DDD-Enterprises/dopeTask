...
| --- | --- | --- |
| C-0001 | `README.md` (`#` heading) | "dopeTask is a deterministic task-packet execution kernel that plans one path or refuses with evidence." |
...
| C-0019 | `docs/11_PUBLIC_CONTRACT.md` (`## Outputs`) | "dopeTask writes deterministic artifacts for a given invocation:" |
...
| C-0028 | `docs/12_ROUTER.md` (`#` heading) | "dopeTask Router v1 selects runner/model pairs deterministically and writes route artifacts." |
